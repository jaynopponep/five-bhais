      ...
      <Table className="border-2 border-customBrown text-xl">
        <TableHeader className="bg-customBrown text-customLight text-2xl font-bold">
          <TableRow className="hover:bg-customBrown">
            <TableHead className="w-[55px] border-customLight flex items-center">
              <Checkbox />
            </TableHead>
            <TableHead className="w-[400px] text-customLight text-center">
              Name
            </TableHead>
            <TableHead className="w-[400px] text-customLight text-center">
              Role
            ...
            <TableHead className="text-customLight w-[300px] text-center">
              Pay (hr)
            </TableHead>
            <TableHead className="text-right text-customLight">
              Actions
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {staff.map((item, index) => (
            <TableRow
              ...
              className={
                index % 2 === 1
                  ? "bg-customBrown/10 hover:bg-customBrown/10"
                  : "hover:bg-customLight"
              }
            >
              ...
              <TableCell className="text-center text-ellipsis truncate w-[500px]">
                {item.role}
              </TableCell>
