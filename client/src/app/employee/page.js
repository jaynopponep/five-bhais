    ...
    <div className="bg-customLight h-screen">
      ...
      <div>
        <div className="flex flex-col justify-center items-center text-customBlack">
          ...
          <div className="text-4xl font-bold mt-20 mb-4"> Employee Log In</div>
          ...
          <div className="text-lg mt-3 font-semilight">Not an employee? Return to <Link href="login" className="font-bold text-blue-600">Customer</Link></div>
        </div>
